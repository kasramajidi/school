...
export default function HeroSubBox() {
  return (
    <div className='lg:hidden sm:flex  flex-col items-center justify-between rounded-xl py-[24px] px-[50px]  w-[100%] bg-[#FFEFE5] border-[2px] border-[#262626] shadow-[8px_8px_0px_1px_#FFBE99]'>
        ...
        <div className='border-b-[2px] border-[#262626] border-solid mt-[20px] w-[228px]'></div>
        <div className='flex flex-col'>
